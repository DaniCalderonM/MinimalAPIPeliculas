...
namespace MinimalAPIPeliculas.Endpoints
{
    public static class PeliculasEndpoints
    {
        ...
        static async Task<Ok<List<PeliculaDTO>>> ObtenerTodos(IRepositorioPeliculas repositorio,
            IMapper mapper, int pagina = 1, int recordPorPagina = 10)
        {
            var paginacion = new PaginacionDTO { Pagina = pagina, RecordsPorPagina = recordPorPagina };
            ...
            IRepositorioActores repositorioActores, IMapper mapper)
        {
            ...
            // Con el select, lo que hacemos es proyectar lo que solamente queremos obtener, es decir
            // aqui soloi queremos acceder al campo ActorId
